  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to B2C Car Sharing v3, your gateway to easily accessible vehicles. Simplifying your journey with centralized management and proximity-based bookings."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to B2C Car Sharing v3, your gateway to easily accessible vehicles. Simplifying your journey with centralized management and proximity-based bookings.`}
            </Text>
            <Box
